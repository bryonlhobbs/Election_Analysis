...
# Declare dictionary to track votes received
candidate_votes = {}
...
with open(file_to_load) as election_data:
    ...
    for row in file_reader:
        ...
        if candidate_name not in candidate_options:
            ...
            # Start tracker for counting a candidate's votes
...
# Print the final vote count to the terminal.
    ...
    # Save winning candidate's result to the text file.
...
# 2. A complete list of the candidates who received votes -- DONE
# 3. The percentage of votes each candidate received -- DONE
